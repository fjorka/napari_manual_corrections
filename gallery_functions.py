...
def smallStack_generate(myIm,data,myTrack,imSize=100):
...
def stack_create_all(myIm,myLabels,myIm_signal_list,data,myTrack,imSize=100):
    ...
    output:
        stack_track
        stack_labels
        stack_signal_list - this is a list itself for all the signal images
    '''
    
    # generate a stack for tracking channel
    stack_track = smallStack_generate(myIm,data,myTrack,imSize=100)
    
    # generate a stack for labels
    stack_labels = smallStack_generate(myLabels,data,myTrack,imSize=100)
    ...
    for myIm_signal in myIm_signal_list:
        ...
        stack_signal_list.append(temp_stack)
        
    return stack_track,stack_labels,stack_signal_list
